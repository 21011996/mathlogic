...
public abstract class CNF implements Comparable<CNF> {
    ...
    CNF first() {
        if (this.isAtom()) {
            ...
            try {
                LinkedList<Pair<CNF, BigInteger>> list = new LinkedList<Pair<CNF, BigInteger>>(((ListOfOrdinals) this).list.subList(0, 1));
                return new ListOfOrdinals(list, new Atom(BigInteger.ZERO));
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
    ...
    CNF firstn(Integer n) {
        if (this.first().isAtom()) return this.first();
            ...
            ListOfOrdinals list = (ListOfOrdinals) this.first();
            if (n > 1) {
                CNF temp = this.first().rest().firstn(n - 1);
                if (temp.isAtom()) {
                    try {
                        return new ListOfOrdinals(list.list, (Atom) temp);
                    } catch (Exception e) {
                        e.printStackTrace();
                        return null;
                    }
                } else {
                    LinkedList<Pair<CNF, BigInteger>> list1 = ((ListOfOrdinals) temp).list;
                    try {
                        LinkedList<Pair<CNF, BigInteger>> finalList = new LinkedList<Pair<CNF, BigInteger>>(list.list);
                        finalList.addAll(list1);
                        return new ListOfOrdinals(finalList, ((ListOfOrdinals) temp).atom);
                    } catch (Exception e) {
                        e.printStackTrace();
                        return null;
                    }
                ...
                if (temp.isAtom()) {
                    ...
                    try {
                        LinkedList<Pair<CNF, BigInteger>> finalList = new LinkedList<Pair<CNF, BigInteger>>(list.list);
                        finalList.addAll(list1);
                        return new ListOfOrdinals(finalList, new Atom(BigInteger.ZERO));
                    } catch (Exception e) {
                        e.printStackTrace();
                        return null;
                    }
    ...
    CNF rest() {
        if (!this.isAtom()) {
            if (((ListOfOrdinals) this).list.size() == 1)
                return ((ListOfOrdinals) this).atom;
            else {
                LinkedList<Pair<CNF, BigInteger>> list = new LinkedList<Pair<CNF, BigInteger>>(((ListOfOrdinals) this).list.subList(((ListOfOrdinals) this).list.size() - 1, ((ListOfOrdinals) this).list.size()));
                try {
                    return new ListOfOrdinals(list, ((ListOfOrdinals) this).atom);
                } catch (Exception e) {
                    e.printStackTrace();
                    return null;
                }
    ...
    CNF fe() {
        if (this.isAtom()) {
            ...
            return ((ListOfOrdinals) this).list.getFirst().getKey();
        }
    }
    ...
    BigInteger fc() {
        if (this.isAtom()) {
            ...
            return ((ListOfOrdinals) this).list.getFirst().getValue();
        }
    }
    ...
    Integer length() {
        if (this.isAtom()) {
            ...
            return 1 + ((ListOfOrdinals) this).rest().length();
        }
    }
    ...
    Integer size() {
        if (this.isAtom()) {
            ...
            return ((ListOfOrdinals) this).fe().size() + ((ListOfOrdinals) this).rest().size();
        }
    }
    ...
    CNF addNext(Pair<CNF, BigInteger> pair, CNF cnf) {
        if (cnf.isAtom()) {
            ...
            list.add(pair);
            try {
                return new ListOfOrdinals(list, (Atom) cnf);
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        } else {
            LinkedList<Pair<CNF, BigInteger>> list = ((ListOfOrdinals) cnf).list;
            list.addFirst(pair);
            try {
                return new ListOfOrdinals(list, ((ListOfOrdinals) cnf).atom);
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        ...
        if (this.isAtom()) {
            ...
            if (!this.first().isAtom()) {
                ...
                if (temp.isAtom()) {
                    ...
                    LinkedList<Pair<CNF, BigInteger>> finalList = new LinkedList<Pair<CNF, BigInteger>>(list.list);
                    finalList.addAll(((ListOfOrdinals) temp).list);
                    try {
                        return new ListOfOrdinals(finalList, ((ListOfOrdinals) temp).atom);
                    } catch (Exception e) {
                        e.printStackTrace();
    ...
    CNF exp1(Atom arg1, CNF arg2) {
        try {
            ...
            if (arg2.isAtom()) {
                ...
                ListOfOrdinals listOfOrdinals = new ListOfOrdinals(list, new Atom(BigInteger.ZERO));
                LinkedList<Pair<CNF, BigInteger>> list1 = new LinkedList<Pair<CNF, BigInteger>>();
                list1.add(new Pair<CNF, BigInteger>(listOfOrdinals, arg1.value.pow(((Atom) arg2.rest()).value.intValue())));
                return new ListOfOrdinals(list1, new Atom(BigInteger.ZERO));
            }
    ...
    CNF exp2(CNF arg1, Atom arg2) {
        ...
        try {
            ...
            return (new ListOfOrdinals(list, new Atom(BigInteger.ZERO))).mul(arg1);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    CNF exp4(CNF arg1, CNF arg2) {
        try {
            ...
            return (new ListOfOrdinals(list, new Atom(BigInteger.ZERO))).mul(exp3(arg1, arg2.natpart()));
        } catch (Exception e) {
            return null;
        }
    }
